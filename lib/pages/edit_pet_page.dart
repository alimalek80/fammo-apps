...
class _EditPetPageState extends State<EditPetPage> {
  ...
  void _initializeFormData() {
    _formData = PetFormData(
      ...
      ageCategory: widget.pet.ageCategory,
      ...
      bodyType: widget.pet.bodyType,
      activityLevel: widget.pet.activityLevel,
      foodFeeling: widget.pet.foodFeeling,
      treatFrequency: widget.pet.treatFrequency,
    );
    
    // Initialize list fields
    if (widget.pet.foodTypes != null) {
      _formData.foodTypes.addAll(widget.pet.foodTypes!);
    }
    if (widget.pet.foodAllergies != null) {
      _formData.foodAllergies.addAll(widget.pet.foodAllergies!);
    }
    if (widget.pet.healthIssues != null) {
      _formData.healthIssues.addAll(widget.pet.healthIssues!);
    }
    ...
    if (widget.pet.ageWeeks != null) {
      _ageWeeksController.text = widget.pet.ageWeeks.toString();
    }
  }
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final pet = await _petService.updatePet(widget.pet.id, _formData, imageFile: _selectedImage);
            ...
            child: Stack(
              children: [
                Container(
                  ...
                  child: (_selectedImage == null && widget.pet.image == null)
                      ? Column(
                ...
                if (_selectedImage != null || widget.pet.image != null)
                  Positioned(
                    bottom: 0,
                    right: 0,
                    child: Container(
